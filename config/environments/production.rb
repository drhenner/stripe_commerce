Hadean::Application.configure do
  ...
  config.action_controller.perform_caching = true
    ...
    config.action_controller.asset_host = "https://www.ror-e.com"
  #end
  ...
  config.action_mailer.default_url_options = { :host => 'www.ror-e.com' }
  config.action_mailer.asset_host = "https://www.ror-e.com"
